cmd_spl/u-boot-spl.cfgout := /opt/gcc-linaro-7.5.0-2019.12-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-gcc -E -Wp,-MD,spl/.u-boot-spl.cfgout.d  -nostdinc -isystem /opt/gcc-linaro-7.5.0-2019.12-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/7.5.0/include -Iinclude     -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__    -D__ARM__ -Wa,-mimplicit-it=always  -mthumb -mthumb-interwork  -mabi=aapcs-linux  -mword-relocations  -fno-pic  -mno-unaligned-access  -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float    -pipe  -march=armv7-a -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a    -x c -o spl/u-boot-spl.cfgout arch/arm/mach-imx/spl_sd.cfg

source_spl/u-boot-spl.cfgout := arch/arm/mach-imx/spl_sd.cfg

deps_spl/u-boot-spl.cfgout := \
...
spl/u-boot-spl.cfgout: $(deps_spl/u-boot-spl.cfgout)
